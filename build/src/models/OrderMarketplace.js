...
exports.orderMarketplaceSchema = void 0;
exports.createOrderMarketplaceModel = createOrderMarketplaceModel;
const mongoose_1 = require("mongoose");
exports.orderMarketplaceSchema = new mongoose_1.Schema({
...
function createOrderMarketplaceModel(conn) {
    return conn.model('OrderMarketplace', exports.orderMarketplaceSchema);
}
